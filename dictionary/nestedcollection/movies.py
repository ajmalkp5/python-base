...
print(len(movies))
 ...
 # run time more than 150

run_time_gt150=[movie.get("title") for movie in movies if int( movie.get("runtime"))>150]
print(run_time_gt150)
...
# filim_id=int(input("enter filim id"))
# for m in movies:
#     if filim_id==m.get("id"):
#         print(m.get("title"))
